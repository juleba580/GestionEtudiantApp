...
namespace GestionEtudiantApp.Controllers
{
    public class EtudiantsController : Controller
    {
        private readonly GestionEtudiantAppDbContext _context;

        public EtudiantsController(GestionEtudiantAppDbContext context)
        {
            _context = context;
        }
